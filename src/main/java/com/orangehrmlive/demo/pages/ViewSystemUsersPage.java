...
//    WebElement status1;
    ...
    public void clickOnUserRoleDropDown(){
        ...
        Reporter.log("Click on user role ");
        CustomListeners.test.log(Status.PASS, "Click on user role ");
    }

    public void cLickOnAdminRole() {
        clickOnElement(adminInUserDropDown);
        Reporter.log("Click on admin role " );
        CustomListeners.test.log(Status.PASS, "Click on admin role " );
    }
