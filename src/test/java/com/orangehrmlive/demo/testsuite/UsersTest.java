...
public class UsersTest extends BaseTest {
    ...
    public void searchTheUserAndVerifyTheMessageRecordFound(String userName2, String userRole, String employeeName, String Status) throws InterruptedException {
        loginPage.enterUserName("Admin");
        loginPage.enterThePassword("admin123");
        loginPage.clickOnLoginButton();
        dashboardPage.clickOnAdmin();
